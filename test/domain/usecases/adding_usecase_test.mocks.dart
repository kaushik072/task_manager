...
// in task_manager/test/domain/usecases/adding_usecase_test.dart.
...
import 'package:task_manager/data/datasources/task_datasource.dart' as _i3;
...
class MockTaskDataSource extends _i1.Mock implements _i3.TaskDataSource {
  MockTaskDataSource() {
  ...
  @override
  _i4.Future<List<_i5.Task>> getTask() => (super.noSuchMethod(
        Invocation.method(
          #getTask,
          [],
        ),
