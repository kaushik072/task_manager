...
// in task_manager/test/presentation/bloc/task_bloc_test.dart.
...
import 'package:task_manager/domain/model/task_model.dart' as _i5;
import 'package:task_manager/domain/repository/task_repository.dart' as _i2;
import 'package:task_manager/domain/usecases/adding_usecase.dart' as _i6;
import 'package:task_manager/domain/usecases/deleting_usecase.dart' as _i7;
import 'package:task_manager/domain/usecases/fetching_usecase.dart' as _i3;
...
class MockGetTasksUseCase extends _i1.Mock implements _i3.GetTasksUseCase {
  ...
  @override
  _i4.Future<List<_i5.Task>> execute() => (super.noSuchMethod(
        Invocation.method(
          #execute,
          [],
        ),
...
class MockAddTaskUseCase extends _i1.Mock implements _i6.AddTaskUseCase {
  ...
  @override
  _i4.Future<dynamic> execute(_i5.Task? task) => (super.noSuchMethod(
        Invocation.method(
          #execute,
          [task],
        ),
